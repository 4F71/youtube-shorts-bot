...
def download_video(url: str, video_id: str, output_dir: Path) -> Path:
    ...
    def _download_once() -> Path:
        ...
        ydl_opts = {
            ...
            'cookiefile': str(BASE_DIR / 'www.instagram.com_cookies.txt') if (BASE_DIR / 'www.instagram.com_cookies.txt').exists() else None,
        }
...
if __name__ == "__main__":
    ...
    test_video = {
        "id": "test_001",
        "url": "https://www.instagram.com/reel/DT75qD9iI7L/?utm_source=ig_web_copy_link",
        "platform": "instagram",
    }
